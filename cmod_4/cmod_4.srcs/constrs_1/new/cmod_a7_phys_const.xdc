...
#create_generated_clock -name design_1_i/clk_div_1_MHz_0/U0/clk_1_MHz_o -source [get_pins design_1_i/clk_wiz/inst/mmcm_adv_inst/CLKOUT0] -divide_by 104 -add -master_clock [get_clocks -of [get_pins design_1_i/clk_wiz/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == sysclk}] [get_pins design_1_i/clk_div_1_MHz_0/U0/clk_1_MHz_o_reg/Q]
#create_generated_clock -name design_1_i/clk_div_1_MHz_0/U0/clk_1_MHz_o_1 -source [get_pins design_1_i/clk_wiz/inst/mmcm_adv_inst/CLKOUT0] -divide_by 104 -add -master_clock [get_clocks -of [get_pins design_1_i/clk_wiz/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}] [get_pins design_1_i/clk_div_1_MHz_0/U0/clk_1_MHz_o_reg/Q]



#create_clock -period 1000.000 -name clk_1_MHz -waveform {0.000 500.000} [get_pins design_1_i/clk_wiz/clk_out_104_MHz]

#create_clock -period 1000.000 -name clk_1_MHz -waveform {0.000 500.000} [get_ports clk_1_MHz]

#set_clock_groups -asynchronous -group [get_clocks clk_out_104_MHz_design_1_clk_wiz_1] -group [get_clocks clk_1_MHz]

#create_generated_clock -name design_1_i/clk_div_1_MHz_0/U0/clk_1_MHz_o -source [get_pins design_1_i/clk_wiz/inst/mmcm_adv_inst/CLKOUT0] -divide_by 104 [get_pins design_1_i/clk_div_1_MHz_0/U0/clk_1_MHz_o_reg/Q]
