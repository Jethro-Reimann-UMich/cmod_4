...
design_libs=(simprims_ver xpm xbip_utils_v3_0_11 axi_utils_v2_0_7 xbip_pipe_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 xbip_dsp48_wrapper_v3_0_5 xbip_dsp48_addsub_v3_0_7 xbip_dsp48_multadd_v3_0_7 dds_compiler_v6_0_23 xil_defaultlib)
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cdr_dds_compiler xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cdr_dds_compiler -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cdr_dds_compiler_sc.so .tmp_log xcelium_lib waves.shm c.obj)
