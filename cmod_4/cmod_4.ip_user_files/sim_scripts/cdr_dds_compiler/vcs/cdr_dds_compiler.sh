...
#
# Script generated by Vivado on Tue Mar 26 12:42:22 -0400 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cdr_dds_compiler.sh
...
#
# Usage        : cdr_dds_compiler.sh
#                cdr_dds_compiler.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cdr_dds_compiler.sh [-reset_run]
#                cdr_dds_compiler.sh [-reset_log]
#                cdr_dds_compiler.sh [-help]
#
...
#                script (type 'cdr_dds_compiler.sh -help' for more information).
#
...
design_libs=(xpm xbip_utils_v3_0_11 axi_utils_v2_0_7 xbip_pipe_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 xbip_dsp48_wrapper_v3_0_5 xbip_dsp48_addsub_v3_0_7 xbip_dsp48_multadd_v3_0_7 dds_compiler_v6_0_23 xil_defaultlib)

# simulation root library directory
sim_lib_dir="vcs_lib"

# script info
echo -e "cdr_dds_compiler.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cdr_dds_compiler.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cdr_dds_compiler xil_defaultlib.glbl -o cdr_dds_compiler_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cdr_dds_compiler_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cdr_dds_compiler_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cdr_dds_compiler_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cdr_dds_compiler.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cdr_dds_compiler.sh [-help]\n\
Usage: cdr_dds_compiler.sh [-step]\n\
Usage: cdr_dds_compiler.sh [-lib_map_path]\n\
Usage: cdr_dds_compiler.sh [-reset_run]\n\
Usage: cdr_dds_compiler.sh [-reset_log]\n\
Usage: cdr_dds_compiler.sh [-keep_index]\n\
Usage: cdr_dds_compiler.sh [-noclean_files]\n\n\
