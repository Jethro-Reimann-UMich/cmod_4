...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cmod_4.gen/sources_1/ip/cdr_sm_ila_2/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cdr_sm_ila_2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cdr_sm_ila_2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cdr_sm_ila_2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
