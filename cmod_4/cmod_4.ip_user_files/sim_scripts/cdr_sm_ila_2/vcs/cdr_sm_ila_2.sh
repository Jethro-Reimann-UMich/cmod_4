...
#
# Script generated by Vivado on Tue Mar 26 12:41:57 -0400 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cdr_sm_ila_2.sh
...
#
# Usage        : cdr_sm_ila_2.sh
#                cdr_sm_ila_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cdr_sm_ila_2.sh [-reset_run]
#                cdr_sm_ila_2.sh [-reset_log]
#                cdr_sm_ila_2.sh [-help]
#
...
#                script (type 'cdr_sm_ila_2.sh -help' for more information).
#
...
# script info
echo -e "cdr_sm_ila_2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cdr_sm_ila_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../cmod_4.gen/sources_1/ip/cdr_sm_ila_2/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cdr_sm_ila_2 xil_defaultlib.glbl -o cdr_sm_ila_2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cdr_sm_ila_2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cdr_sm_ila_2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cdr_sm_ila_2_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cdr_sm_ila_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cdr_sm_ila_2.sh [-help]\n\
Usage: cdr_sm_ila_2.sh [-step]\n\
Usage: cdr_sm_ila_2.sh [-lib_map_path]\n\
Usage: cdr_sm_ila_2.sh [-reset_run]\n\
Usage: cdr_sm_ila_2.sh [-reset_log]\n\
Usage: cdr_sm_ila_2.sh [-keep_index]\n\
Usage: cdr_sm_ila_2.sh [-noclean_files]\n\n\
