...
design_libs=(xpm xbip_utils_v3_0_11 xbip_pipe_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.i_q_channel_mult_gen xil_defaultlib.glbl -o i_q_channel_mult_gen_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./i_q_channel_mult_gen_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key i_q_channel_mult_gen_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc i_q_channel_mult_gen_simv.daidir vcs_lib c.obj)
