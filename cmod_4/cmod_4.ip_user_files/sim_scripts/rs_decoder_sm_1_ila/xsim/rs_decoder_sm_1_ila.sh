...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rs_decoder_sm_1_ila xil_defaultlib.rs_decoder_sm_1_ila xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rs_decoder_sm_1_ila -key {Behavioral:sim_1:Functional:rs_decoder_sm_1_ila} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rs_decoder_sm_1_ila.wdb xsim.dir libdpi.so)
