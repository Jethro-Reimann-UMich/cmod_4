...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.freq_err_mult_gen xil_defaultlib.glbl -o freq_err_mult_gen_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./freq_err_mult_gen_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key freq_err_mult_gen_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc freq_err_mult_gen_simv.daidir vcs_lib c.obj)
