...
#
# Script generated by Vivado on Tue Mar 26 12:42:35 -0400 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : agc_div_gen.sh
...
#
# Usage        : agc_div_gen.sh
#                agc_div_gen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                agc_div_gen.sh [-reset_run]
#                agc_div_gen.sh [-reset_log]
#                agc_div_gen.sh [-help]
#
...
#                script (type 'agc_div_gen.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_11 -libname axi_utils_v2_0_7 -libname xbip_pipe_v3_0_7 -libname xbip_dsp48_wrapper_v3_0_5 -libname xbip_dsp48_addsub_v3_0_7 -libname xbip_bram18k_v3_0_7 -libname mult_gen_v12_0_19 -libname floating_point_v7_0_21 -libname xbip_dsp48_mult_v3_0_7 -libname xbip_dsp48_multadd_v3_0_7 -libname div_gen_v5_1_20 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_11 axi_utils_v2_0_7 xbip_pipe_v3_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_dsp48_addsub_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 floating_point_v7_0_21 xbip_dsp48_mult_v3_0_7 xbip_dsp48_multadd_v3_0_7 div_gen_v5_1_20 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "agc_div_gen.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./agc_div_gen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.agc_div_gen xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.agc_div_gen -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log agc_div_gen_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./agc_div_gen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: agc_div_gen.sh [-help]\n\
Usage: agc_div_gen.sh [-step]\n\
Usage: agc_div_gen.sh [-lib_map_path]\n\
Usage: agc_div_gen.sh [-reset_run]\n\
Usage: agc_div_gen.sh [-reset_log]\n\
Usage: agc_div_gen.sh [-keep_index]\n\
Usage: agc_div_gen.sh [-noclean_files]\n\n\
