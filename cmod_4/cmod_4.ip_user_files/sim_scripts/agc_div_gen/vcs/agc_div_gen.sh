...
design_libs=(xpm xbip_utils_v3_0_11 axi_utils_v2_0_7 xbip_pipe_v3_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_dsp48_addsub_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 floating_point_v7_0_21 xbip_dsp48_mult_v3_0_7 xbip_dsp48_multadd_v3_0_7 div_gen_v5_1_20 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.agc_div_gen xil_defaultlib.glbl -o agc_div_gen_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./agc_div_gen_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key agc_div_gen_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc agc_div_gen_simv.daidir vcs_lib c.obj)
