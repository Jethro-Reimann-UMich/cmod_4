...
#
# Script generated by Vivado on Tue Mar 26 12:42:16 -0400 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : freq_err_fir_1.sh
...
#
# Usage        : freq_err_fir_1.sh
#                freq_err_fir_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                freq_err_fir_1.sh [-reset_run]
#                freq_err_fir_1.sh [-reset_log]
#                freq_err_fir_1.sh [-help]
#
...
#                script (type 'freq_err_fir_1.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_11 -libname axi_utils_v2_0_7 -libname fir_compiler_v7_2_20 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_11 axi_utils_v2_0_7 fir_compiler_v7_2_20 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "freq_err_fir_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./freq_err_fir_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.freq_err_fir_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.freq_err_fir_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log freq_err_fir_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./freq_err_fir_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: freq_err_fir_1.sh [-help]\n\
Usage: freq_err_fir_1.sh [-step]\n\
Usage: freq_err_fir_1.sh [-lib_map_path]\n\
Usage: freq_err_fir_1.sh [-reset_run]\n\
Usage: freq_err_fir_1.sh [-reset_log]\n\
Usage: freq_err_fir_1.sh [-keep_index]\n\
Usage: freq_err_fir_1.sh [-noclean_files]\n\n\
