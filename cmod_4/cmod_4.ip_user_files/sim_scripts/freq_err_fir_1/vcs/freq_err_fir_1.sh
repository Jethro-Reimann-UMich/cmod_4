...
design_libs=(xpm xbip_utils_v3_0_11 axi_utils_v2_0_7 fir_compiler_v7_2_20 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.freq_err_fir_1 xil_defaultlib.glbl -o freq_err_fir_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./freq_err_fir_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key freq_err_fir_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc freq_err_fir_1_simv.daidir vcs_lib c.obj)
